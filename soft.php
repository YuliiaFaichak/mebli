...
<body id="page1" onload="new ElementMaxHeight();">
	<div id="main">
               ...
               <div class="header-box">
                  <div class="inner">
                     <ul class="nav">
                        ...
                        <li><a href="soft.php"  class="current">М'які меблі</a></li>
		...
		<div id="content">
            ...
            <div class="content">
            	<div class="indent">
                  <img class="img-indent png" alt="" src="img/couch1.png" width="180px" height="70px"/>
                  <p class="alt-top">Диван Вінтаж - 5000грн<br/><br/><br/>

                  <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/couch2.png" width="180px" height="100px" />
                  <p class="alt-top">Диван Брюсель 9000грн<br/><br/><br/><br/><br/>
            
                  <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/couch3.png" width="180px" height="70px" />
                  <p class="alt-top">Диван Флоренція 12000грн<br/><br/><br/>

                  <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/couch4.png" width="180px" height="70px" />
                  <p class="alt-top">Диван "Париж" 10000грн<br/><br/><br/>

                                    <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/couch5.png" width="180px" height="70px" />
                  <p class="alt-top">Диван "Меблева розкіш" 10000грн<br/><br/><br/>
