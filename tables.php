...
<body id="page1" onload="new ElementMaxHeight();">
	<div id="main">
               ...
               <div class="header-box">
                  <div class="inner">
                     ...
                     <li><a href="index.php">Головна</a></li>
                        ...
                        <li><a href="tables.php"  class="current">Столи</a></li>
		...
		<div id="content">
            ...
            <div class="content">
            	<div class="indent">
                  <img class="img-indent png" alt="" src="img/table1.png" width="140px" height="70px"/>
                  <p class="alt-top">Стіл "Прованс" - 3000грн<br/><br/><br/>
                  <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/table2.png" width="180px"  />
                  <p class="alt-top">Стіл журнальний 1000грн<br/><br/><br/><br/><br/><br/><br/>
            
                  <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/table3.png" width="180px" />
                  <p class="alt-top">Стіл "Дуб" 12000грн<br/><br/><br/><br/><br/><br/><br/>

                  <div class="clear"></div>
                  <img class="img-indent png" alt="" src="img/table4.png" width="180px" />
                  <p class="alt-top">Стіл письмовий 2400грн<br/><br/><br/><br/><br/><br/><br/>
